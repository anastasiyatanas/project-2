...
if (keycode == '13') {
countryCode1 = $(".countrySelect1").val().toLowerCase();
console.log(countryCode1);
queryURL = "http://inqstatsapi.inqubu.com/?api_key=01af562d77e556bb&data=medianwage,jobless_rate,bigmac_index,gini,life_expectancy,murder_rate,death_rate,happiness_index,corruption_index,literacy_rate,tax_revenue_total,median_age,capital_coordinates&countries=" + countryCode1;
...
if (countryCode1 !== "") {
    $.ajax({
        ...
        if (typeof res === "string") {
            ...
            lat=res[0].capital_coordinates.split(",");
            console.log(lat);
